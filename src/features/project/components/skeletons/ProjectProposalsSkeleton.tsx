...
export const ProjectProposalsSkeleton = () => {
    return (
                ...
                <div className="w-full overflow-x-auto">
                    <table className="w-full min-w-[900px] text-right border-collapse whitespace-nowrap">
                        ...
                        <tr className="border-b border-brand-border/50 bg-white/[0.02] text-xs uppercase tracking-widest">
                            <th className="p-6 font-black"><div className="h-3 w-4 bg-white/5 rounded mx-auto" /></th>
                            ...
                            <th className="p-6 font-black"><div className="h-3 w-16 bg-white/5 rounded mx-auto" /></th>
                            <th className="p-6 font-black"><div className="h-3 w-12 bg-white/5 rounded mx-auto" /></th>
                            <th className="p-6 font-black"><div className="h-3 w-12 bg-white/5 rounded mx-auto" /></th>
                            <th className="p-6 font-black"><div className="h-3 w-16 bg-white/5 rounded mx-auto" /></th>
                        </tr>
                        </thead>
                        ...
                        {Array.from({ length: 3 }).map((_, i) => (
                            <tr key={i} className="transition-all duration-300">
                                ...
                                {/* Status */}
                                <td className="p-6">
                                    <div className="h-6 w-16 bg-white/5 rounded-lg mx-auto" />
                                </td>
